...
def admin_panel_kb(is_owner: bool = False) -> InlineKeyboardMarkup:
    rows = [
        ...
        [
            InlineKeyboardButton(text="💰 Prices", callback_data="admin_manage_prices"),
            InlineKeyboardButton(text="💳 Deposits", callback_data="admin_pending_deposits"),
        ],
        [
...
def admin_settings_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="💰  Min Deposit Amount (₹)  ", callback_data="admin_set_min_deposit")],
        [InlineKeyboardButton(text="🎁  Referral Join Bonus (₹)  ", callback_data="admin_set_referral")],
        [InlineKeyboardButton(text="📊  Referral Deposit %  ", callback_data="admin_set_referral_pct")],
...
def countries_toggle_kb(countries: list) -> InlineKeyboardMarkup:
    ...
    for c in countries:
        ...
        rows.append([
            ...
            InlineKeyboardButton(
                text="🗑️",
                callback_data=f"delete_country:{c['code']}"
            ),
        ])
    rows.append([
        InlineKeyboardButton(text="➕  Add Country  ", callback_data="admin_add_country"),
        InlineKeyboardButton(text="🔄  Reset All  ", callback_data="admin_reset_countries"),
    ])
    rows.append([InlineKeyboardButton(text="◀️  Back  ", callback_data="admin_panel")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
