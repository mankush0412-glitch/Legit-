...
def admin_panel_kb(is_owner: bool = False) -> InlineKeyboardMarkup:
    rows = [
        [
            ...
            InlineKeyboardButton(text="💰 Prices & Countries", callback_data="admin_manage_prices"),
        ],
        [
        ...
        [
            InlineKeyboardButton(text="🗂 View & Clear Sessions", callback_data="admin_view_sessions"),
        ],
    ]
    if is_owner:
        rows.append([
